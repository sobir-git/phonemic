...
install -m 644 "$SRC/lib/audio.py"    "$PREFIX/lib/audio.py"
install -m 644 "$SRC/lib/desktop_control.py" "$PREFIX/lib/desktop_control.py"
install -m 644 "$SRC/lib/dictation.py" "$PREFIX/lib/dictation.py"
install -m 644 "$SRC/lib/http_server.py" "$PREFIX/lib/http_server.py"
install -m 644 "$SRC/lib/phone_page.py" "$PREFIX/lib/phone_page.py"
install -m 644 "$SRC/lib/session.py" "$PREFIX/lib/session.py"
install -m 644 "$SRC/lib/herdr_detect.py" "$PREFIX/lib/herdr_detect.py"
install -m 644 "$SRC/lib/herdr.py"    "$PREFIX/lib/herdr.py"
